"""Console entry point for the bundled RLAIF training example."""
...
def main() -> None:
    module = _load_repo_module(
        "scripts/example_rlaif_training.py",
        "rlaif_example_training",
    )
    if not hasattr(module, "main"):
        raise RuntimeError(
            "scripts/example_rlaif_training.py does not expose a main() entry point"
        )
    module.main()
